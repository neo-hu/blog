...
})(ToastyEventType = exports.ToastyEventType || (exports.ToastyEventType = {}));
...
exports.ToastyEvent = ToastyEvent;
function toastyServiceFactory(config) {
    return new ToastyService(config);
}
exports.toastyServiceFactory = toastyServiceFactory;
/**
...
var ToastyService = ToastyService_1 = (function () {
    ...
    ToastyService.prototype.add = function (options, type) {
        ...
        var toast = {
            ...
            onClick: toastyOptions.onClick && toasty_utils_1.isFunction(toastyOptions.onClick) ? toastyOptions.onClick : null
        };
