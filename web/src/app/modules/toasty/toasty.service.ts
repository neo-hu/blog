...
export class ToastyService {
   ...
   */
  default(options: ToastOptions|string|number): ToastData {
   ...
   */
  info(options: ToastOptions|string|number): ToastData {
   ...
   * @param  {object} options Individual toasty config overrides
   */
  success(options: ToastOptions|string|number): ToastData {
   ...
   * @param  {object} options Individual toasty config overrides
   */
  wait(options: ToastOptions|string|number): ToastData {
   ...
   * @param  {object} options Individual toasty config overrides
   */
  error(options: ToastOptions|string|number): ToastData {
   ...
   * @param  {object} options Individual toasty config overrides
   */
  warning(options: ToastOptions|string|number): ToastData {
    return this.add(options, 'warning');
  }


  // Add a new toast item
  private add(options: ToastOptions|string|number, type: string): ToastData {
